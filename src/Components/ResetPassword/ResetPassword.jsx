...
export default function ResetPassword() {
    ...
    async function ResetPasswordFun(values){
        try {
            ...
            toast.error(error.response.data.message,{className:"bg-danger text-white py-1 h6"});
        }
    }
    return   <> 
    <Helmet>
    ...
    <div className='w-75 mx-auto my-5 pb-5'>
        ...
        <form onSubmit={formik.handleSubmit}>
            ...
            <button className='btn btn-info mt-2' type="submit">Reset Password</button>
        </form>
    </div>
</>
}
